    ...
    def normalize_source(source)
      ...
      when :gemcutter, :rubygems, :rubyforge
        Bundler::SharedHelpers.major_deprecation 2, "The source :#{source} is deprecated because HTTP " \
          ...
          "rubygems.org' i# frozen_string_literal: true
  ...
  class Dsl
    ...
    def source(source, *args, &blk)
      ...
      if options.key?("type")
        ...
        unless block_given?
          raise InvalidOption, "You need to pass a block to #f possible, or 'http://rubygems.org' if not."
        "http://rubygems.org"
      when String
        source
      else
