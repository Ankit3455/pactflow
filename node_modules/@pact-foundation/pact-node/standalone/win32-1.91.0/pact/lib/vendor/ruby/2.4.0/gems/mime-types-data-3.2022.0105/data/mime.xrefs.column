...
draft^draft-ietf-sidrops-rpki-rsc-02
...
person^Frederic_Firmin|template^application/vnd.3gpp.interworking-data
...
person^Gaigrfc^rfc6015|template^application/1d-interleaved-parityfec
person^Ozgur_Oyman^_3GPP|template^application/3gpdash-qoe-report+xml
person^John_M_Meredith^_3GPP|template^application/3gpp-ims+xml
...
-
-
draft^RFC-ietf-ace-oauth-authz-46|template^application/ace+cbor
...
person^ISO-IEC_JTC1|template^application/dash-patch+xml
...
person^DICOM_Standards_Committee^David_Clunie|template^application/dicom+json
person^DICOM_Standards_Committee^David_Clunie|template^application/dicom+xml
...
person^ISO-IEC_JTC1^W3C|template^application/emma+xml|uri^http://www.w3.org/TR/2007/CR-emma-20071211/#media-type-registration
...
-
draft^RFC-ietf-httpbis-messaging-19|template^application/http
...
draft^RFC-ietf-core-new-block-14|template^application/missing-blocks+cbor-seq
...
rfc^rfc3680|template^application/regie_Paulsen|template^application/vnd.cluetrust.cartomobile-config
...
person^ISO-IEC_JTC1^Ingo_Hofmann^Nils_Peters|template^audio/mhas
-
...
-
person^PNG_Working_Group^W3C|template^image/png
...
draft^RFC-ietf-httpbis-messaging-19|template^message/http
...
rfc^rfc2077
person^DICOM_Standards_Committee^Luiza_Kowalczyk|template^model/mtl
person^DICOM_Standards_Committee^Luiza_Kowalczyk|template^model/obj
...
draft^RFC-ietf-httpbis-semantics-19|template^multipart/byteranges
rfc^rfc2045^rfc2046
